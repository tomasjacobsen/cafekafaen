    ...
    <b-container fluid>      
      <b-row class="d-flex justify-content-between align-items-center">
        ...
        <b-col cols=12 md=8 v-else class="order-1 order-md-2 mb-4 mb-md-0">
            <nuxt-image :placeholder="true" :src="`https://res.cloudinary.com/cafekafaen/image/upload/images/${page.image}`" :alt="page.title" sizes="1600" fit="cover" class="img-fluid" />
        </b-col>
